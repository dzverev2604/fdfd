...
//                                         "/404" !== H &&
//                                         "/_error" !== H &&
//                                         (V || (D.nextExport && (w.isDynamicRoute(oe.pathname) || location.search)) || (U && U.__N_SSG && location.search)) &&
//                                         oe.replace(oe.pathname + "?" + String(_.assign(_.urlQueryToSearchParams(oe.query), new URLSearchParams(location.search))), ee, { _h: 1, shallow: !V });
//                                 },
//                             },
//                             {
...
//                                         case 37:
//                                             return (
//                                                 (t.router = oe = A.createRouter(H, W, ee, {
//                                                     initialProps: U,
//                                                     pageLoader: te,
//                                                     App: ae,
//                                                     Component: se,
...
//                             ie && (performance.getEntriesByName("Next.js-render").forEach(ie), performance.getEntriesByName("Next.js-route-change-to-render").forEach(ie)),
//                             be(),
...
//                         },
//                     },
//                     d.default.createElement(g.RouterContext.Provider, { value: A.makePublicRouterInstance(oe) }, d.default.createElement(v.HeadManagerContext.Provider, { value: ue }, t))
//                 );
//             }
//             var _e,
//                 Pe = function (e) {
...
//                                         (m._bps && !m._bps(t)) ||
//                                         m.change("replaceState", r, n, Object.assign({}, o, { shallow: o.shallow && m._shallow, locale: o.locale || m.defaultLocale }), undefined);
//                                 }
//                             } else {
//                                 var u = m.pathname,
//                                     c = m.query;
...
//                         (this.components = {}),
//                         "/_error" !== t) &&
//                         (this.components[this.route] = { Component: l, initial: !0, props: i, err: f, __N_SSG: i && i.__N_SSG, __N_SSP: i && i.__N_SSP, __N_RSC: !!(null === (a = l) || void 0 === a ? void 0 : a.__next_rsc__) });
...
//                                                                     (o.t0 = f),
//                                                                     (o.next = 43),
//                                                                     Promise.all([this.pageLoader.getPageList(), h.getClientBuildManifest(), this.pageLoader.getMiddlewareList()])
//                                                                 );
//                                                             case 43:
...
//                                                                         c && "/_error" !== x && ((a._shouldResolveHref = !0), (P.pathname = q(x, j)), P.pathname !== x && ((x = P.pathname), (P.pathname = M(x)), (r = g.formatWithValidation(P)))),
//                                                                         T(n))
//                                                                 ) {
//                                                                     o.next = 63;
//                                                                     break;
...
//                                                             case 63:
//                                                                 if (((F = A(L(F), this.locale)), 1 === a._h && !b.isDynamicRoute(p.removePathTrailingSlash(x)))) {
//                                                                     o.next = 84;
//                                                                     break;
//                                                                 }
...
//                                                             case 84:
//                                                                 if (((B = p.removePathTrailingSlash(x)), !b.isDynamicRoute(B))) {
//                                                                     o.next = 100;
//                                                                     break;
//                                                                 }
//                                                                 if (((z = w.parseRelativeUrl(F)), (G = z.pathname), ($ = E.getRouteRegex(B)), (V = S.getRouteMatcher($)(G)), (Y = (X = B === G) ? I(B, G, O) : {}), V && (!X || Y.result))) {
//                                                                     o.next = 99;
//                                                                     break;
//                                                                 }
//                                                                 if (
...
//                                                                 throw new Error(
//                                                                     (X
//                                                                         ? "The provided `href` (".concat(r, ") value is missing query values (").concat(K.join(", "), ") to be interpolated properly. ")
//                                                                         : "The provided `as` value (".concat(G, ") is incompatible with the `href` value (").concat(B, "). ")) +
...
//                                                             case 117:
//                                                                 if (((this.isPreview = !!te.__N_PREVIEW), te.notFound !== H)) {
//                                                                     o.next = 132;
//                                                                     break;
//                                                                 }
...
//                                                                     a._h &&
//                                                                     "/_error" === x &&
//                                                                     500 === (null === (Q = self.__NEXT_DATA__.props) || void 0 === Q || null === (J = Q.pageProps) || void 0 === J ? void 0 : J.statusCode) &&
...
//                                                                     (he = pe ? { x: 0, y: 0 } : null),
//                                                                     (o.next = 141),
//                                                                     this.set(B, x, O, m, Z, null !== i && void 0 !== i ? i : he).catch(function (e) {
...
//                                                             case 149:
//                                                                 if (((o.prev = 149), (o.t4 = o.catch(101)), !d.default(o.t4) || !o.t4.cancelled)) {
//                                                                     o.next = 153;
//                                                                     break;
//                                                                 }
...
//                                                             case 18:
//                                                                 if ((p = { props: void 0, Component: s, styleSheets: l, err: t, error: t }).props) {
//                                                                     o.next = 30;
//                                                                     break;
//                                                                 }
...
//                                                         switch ((o.prev = o.next)) {
//                                                             case 0:
//                                                                 if (((o.prev = 0), (s = this.components[e]), !i.shallow || !s || this.route !== e)) {
//                                                                     o.next = 4;
//                                                                     break;
//                                                                 }
...
//                                                             case 17:
//                                                                 return (
//                                                                     (h || y || v) && (m = this.pageLoader.getDataHref({ href: g.formatWithValidation({ pathname: t, query: r }), asPath: a, ssg: h, rsc: v, locale: this.locale })),
//                                                                     (o.next = 21),
//                                                                     this._getData(function () {
//                                                                         return h || y
//                                                                             ? B(m, c.isSsr, !1, h ? c.sdc : c.sdr, !!h && !c.isPreview)
//                                                                             : c.getInitialProps(p, { pathname: t, query: r, asPath: n, locale: c.locale, locales: c.locales, defaultLocale: c.defaultLocale });
//                                                                     })
//                                                                 );
//                                                             case 21:
//                                                                 if (((b = o.sent), !v)) {
...
//                                                                     y.matchedPage && y.resolvedHref && ((u = y.resolvedHref), (i.pathname = u), (e = g.formatWithValidation(i))),
//                                                                     (o.next = 21);
//                                                                 break;
//                                                             case 20:
...
//                                                             case 25:
//                                                                 return (
//                                                                     "rewrite" === (v = o.sent).type && ((i.pathname = v.resolvedHref), (u = v.resolvedHref), (c = l({}, c, v.parsedAs.query)), (f = v.asPath), (e = g.formatWithValidation(i))),
...
//                                                                 }
//                                                                 return (
//                                                                     (i = w.parseRelativeUrl(v.normalizeLocalePath(C(a.rewrite) ? L(a.rewrite) : a.rewrite, this.locales).pathname)),
//                                                                     (u = p.removePathTrailingSlash(i.pathname)),
//                                                                     e.pages.includes(u) ? ((c = !0), (s = u)) : (s = q(u, e.pages)) !== i.pathname && e.pages.includes(s) && (c = !0),
...
//                                                                 }
//                                                                 return (
//                                                                     (l = p.removePathTrailingSlash(v.normalizeLocalePath(C(a.redirect) ? L(a.redirect) : a.redirect, this.locales).pathname)),
//                                                                     (h = U(this, l, l)),
//                                                                     (d = h.url),
//                                                                     (y = h.as),
//                                                                     t.abrupt("return", { type: "redirect", newUrl: d, newAs: y })
//                                                                 );
//                                                             case 23:
...
//                             : { groups: r.groups, namedRegex: "^".concat(r.namedParameterizedRoute).concat(a, "$"), re: new RegExp("^".concat(r.parameterizedRoute).concat(a, "$")), routeKeys: r.routeKeys };
...
//                     return a
//                         ? a.done
//                             ? ((r[e.resultName] = a.value), (r.next = e.nextLoc), "return" !== r.method && ((r.method = "next"), (r.arg = t)), (r.delegate = null), d)
//                             : a
...
//                             return (this.delegate = { iterator: R(e), resultName: r, nextLoc: n }), "next" === this.method && (this.arg = t), d;
//                         },
//                     }),
//                     e
//                 );
